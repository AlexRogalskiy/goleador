...
class VideoUrlFetcherTest {

    @Test
    void extractFromResponse() throws Exception {
        InputStream is = VideoUrlFetcher.class.getResourceAsStream("/get_video_info_DU4Uij016HQ");
        String response = Utils.readInputToString(is);
        String videoUrl = VideoUrlFetcher.extractFromResponse(response, "136");
